...
import { getEnterprisePlatformsContent } from "./constants";

export async function EnterprisePlatformsCta() {
  const locale = (await getLocale()) as Locale;
  const content = getEnterprisePlatformsContent(locale).cta;

  return (
    <section
      aria-labelledby="enterprise-platforms-cta-heading"
    ...
    >
      ...
      >
        <h2
          id="enterprise-platforms-cta-heading"
